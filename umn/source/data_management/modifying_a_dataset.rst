...
.. _modelarts_23_0020__en-us_topic_0170886811_table151481125214:
   ...
   .. table:: **Table 1** Parameters
      ...
      +=============+=======================================================================================================+
      | Name        | Enter the name of the dataset. A dataset name can contain only letters, digits, underscores (_), and  |
      |             | hyphens (-).                                                                                          |
      +-------------+-------------------------------------------------------------------------------------------------------+
      | Description | Enter a brief description for the dataset.                                                            |
      +-------------+-------------------------------------------------------------------------------------------------------+
      | Label Set   | The label set varies depending on the dataset type. For details about how to modify the label set,    |
      |             | see the parameters of different dataset types in `Creating a Dataset <modelarts_23_0004.html>`__.     |
      +-------------+-------------------------------------------------------------------------------------------------------+
