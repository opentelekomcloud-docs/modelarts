...
Log in to the ModelArts management console. In the left navigation pane, choose **Development Workspace > Notebook** to switch to the **Notebooks** page. Perform the following operations to stop or start a notebook instance:
