...
#. :ref:`JSON Text Prediction <en-us_topic_0000002540903378__en-us_topic_0165025306_section15840106121611>`: If the input type of the model of the deployed service is JSON text, that is, the input does not contain files, you can enter the JSON code on the **Prediction** tab page for service testing.
#. :ref:`File Prediction <en-us_topic_0000002540903378__en-us_topic_0165025306_section1666533761611>`: If the input type of the model of the deployed service is file, including images, audios, and videos, you can add images on the **Prediction** tab page for service testing.
...
.. _en-us_topic_0000002540903378__en-us_topic_0165025306_section15840106121611:
...
.. _en-us_topic_0000002540903378__en-us_topic_0165025306_section1666533761611:
