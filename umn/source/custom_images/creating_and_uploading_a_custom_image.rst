...
-  Specifications for custom images. For details about how to use a custom image for a training job, see `Specifications for Custom Images Used for Training Jobs <modelarts_23_0217.html>`__. For details about how to use a custom image for model import, see `Specifications for Custom Images Used for Importing Models <modelarts_23_0219.html>`__.
