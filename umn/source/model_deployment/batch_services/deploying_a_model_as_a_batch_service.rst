...
.. _modelarts230066enustopic0171858292table1029041641314:
      ...
      .. table:: **Table 1** Parameters
         ...
         +-----------------------------------+------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
         | Input Path                        | Select the OBS directory where the data is to be uploaded. Select a folder or a **.manifest** file. For details about the specifications of the **.manifest** file, see `Manifest File Specifications <#modelarts230066enustopic0171858292section190619315314>`__.                                                                                         |
         |                                   |                                                                                                                                                                                                                                                                                                                                                            |
         |                                   | .. note::                                                                                                                                                                                                                                                                                                                                                  |
         |                                   |                                                                                                                                                                                                                                                                                                                                                            |
