...
Log in to the ModelArts management console. In the navigation pane, choose **Permission Management**. Click **View Permissions** to check whether the OBS agency permission is configured.


.. figure:: /_static/images/en-us_image_0000002578735457.png
