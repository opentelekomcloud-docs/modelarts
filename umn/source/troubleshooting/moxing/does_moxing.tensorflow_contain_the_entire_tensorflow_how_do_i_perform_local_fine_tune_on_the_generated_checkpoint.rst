...
When MoXing is used to train a model, **global_step** is placed in the Adam name range. The non-MoXing code does not contain the Adam name range. See :ref:`Figure 1 <en-us_topic_0000002571543029__fig934813253212>`. In the figure, **1** indicates MoXing code, and **2** indicates non-MoXing code.

.. _en-us_topic_0000002571543029__fig934813253212:

.. figure:: /_static/images/en-us_image_0000002571543393.png
