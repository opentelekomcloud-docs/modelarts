...
#. Check whether the first parameter of **moxing.file.copy_parallel()** contains a file. If it contains no file, the error message "No files to copy" is displayed.
   ...
   -  If the file exists, go to :ref:`2 <en-us_topic_0000002043025044__li10628123201314>`.
   -  If the file does not exist, ignore the error and proceed with subsequent operations.

#. .. _en-us_topic_0000002043025044__li10628123201314:
   ...
   -  If they are in the same region, go to step :ref:`3 <en-us_topic_0000002043025044__li2353181314015>`.
...
#. .. _en-us_topic_0000002043025044__li2353181314015:
   ...
   **mox.file.exists('obs://bucket_name/sub_dir_0/sub_dir_1')**
   ...
   -  If the path exists, go to :ref:`4 <en-us_topic_0000002043025044__li4818125404115>`.
   -  If the path does not exist, change it to an available OBS path.

#. .. _en-us_topic_0000002043025044__li4818125404115:
   ...
   **os.system('df -hT')**
   ...
   -  If disk space is sufficient, go to :ref:`5 <en-us_topic_0000002043025044__li16822185814207>`.
   -  If disk space is insufficient, use GPU resources.

#. .. _en-us_topic_0000002043025044__li16822185814207:
