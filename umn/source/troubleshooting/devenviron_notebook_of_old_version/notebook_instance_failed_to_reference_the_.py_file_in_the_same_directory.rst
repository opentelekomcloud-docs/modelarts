...
:ref:`Figure 3 <en-us_topic_0000001909848476__fig441014137119>` shows the directory structure. :ref:`Figure 2 <en-us_topic_0000001909848476__fig784141118401>` provides details about the operation and the error.


.. figure:: /_static/images/en-us_image_0000001909848892.png
   :alt: **Figure 1** Directory structure

   **Figure 1** Directory structure

.. _en-us_topic_0000001909848476__fig784141118401:

.. figure:: /_static/images/en-us_image_0000001909848896.png
...
.. _en-us_topic_0000001909848476__fig441014137119:

.. figure:: /_static/images/en-us_image_0000001910008900.png
...
#. On the **Files** tab page of the **Jupyter** page, select the **a.py** and **b.py** files, and click **Sync OBS** to synchronize the selected objects from the OBS bucket path to the current container directory **~/work**. Then the objects can be invoked in code.
   ...
   .. figure:: /_static/images/en-us_image_0000001910008908.png
