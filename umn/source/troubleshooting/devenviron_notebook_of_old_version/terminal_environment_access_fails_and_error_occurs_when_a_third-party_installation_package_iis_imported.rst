...
#. On the **Files** tab page of the **Jupyter** page, click **New** and select **Terminal**. The **Terminal** page is displayed.
   ...
   .. figure:: /_static/images/en-us_image_0000002233740416.png
      :alt: **Figure 1** Going to the **Terminal** page

      **Figure 1** Going to the **Terminal** page

#. Run the following command to obtain the command line for activating the environment, as shown in :ref:`Figure 2 <en-us_topic_0000002268738945__fig9291155351810>`.
   ...
   .. _en-us_topic_0000002268738945__fig9291155351810:

   .. figure:: /_static/images/en-us_image_0000002268739701.png
