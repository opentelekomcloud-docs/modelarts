...
The code directory fails to be downloaded during training job running, and the following error message is displayed. See :ref:`Figure 1 <en-us_topic_0000002571423111__fig920916392148>`.

.. code-block::

   ERROR: modelarts-downloader.py: Get object key failed: 'Contents'

.. _en-us_topic_0000002571423111__fig920916392148:

.. figure:: /_static/images/en-us_image_0000002540903466.png
