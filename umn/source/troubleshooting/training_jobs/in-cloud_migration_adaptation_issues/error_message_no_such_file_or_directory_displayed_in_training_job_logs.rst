...
.. figure:: /_static/images/en-us_image_0000002541063092.png
...
-  If the training input path is unreachable, the path is incorrect. Perform the following operations to locate the fault:
   ...
   #. :ref:`Checking Whether the Affected Path Is an OBS Path <en-us_topic_0000002571543019__en-us_topic_0000001128983644_section1181277141419>`
   #. :ref:`Checking Whether the Affected Path Is Available <en-us_topic_0000002571543019__en-us_topic_0000001128983644_section135339269>`

-  If the training boot file is unavailable, the path to the training job boot command is incorrect. Rectify the fault by referring to :ref:`Checking the File Boot Path of a Training Job Created Using a Custom Image <en-us_topic_0000002571543019__en-us_topic_0000001128983644_section1193319591840>`.
...
.. _en-us_topic_0000002571543019__en-us_topic_0000001128983644_section1181277141419:
...
.. _en-us_topic_0000002571543019__en-us_topic_0000001128983644_section135339269:
...
.. _en-us_topic_0000002571543019__en-us_topic_0000001128983644_section1193319591840:
