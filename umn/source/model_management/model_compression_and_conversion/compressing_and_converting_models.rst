...
-  ModelArts provides conversion templates for you to choose. For details about the supported templates, see `Conversion Templates <modelarts_23_0110.html>`__.
...
-  When importing the converted model to ModelArts, you need to use the `model template <modelarts_23_0205.html>`__.
