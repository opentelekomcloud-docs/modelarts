:original_name: datalabel-modelarts_0030.html
...
#. Log in to the ModelArts management console. In the navigation pane, choose **Data** **Preparation** > **Label Data**. On the **Data Labeling** page, click **My Participations**. Locate the row containing the target labeling job and click **Review** in the **Operation** column to initiate the review.
