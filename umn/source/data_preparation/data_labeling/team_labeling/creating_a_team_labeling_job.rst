...
-  Choose **Datasets** on the console. In the **Operation** column of the target dataset, click **Labeling**. On the displayed **Create Labeling Job** page, enable **Team Labeling**. You can create multiple team labeling jobs for the same dataset.
