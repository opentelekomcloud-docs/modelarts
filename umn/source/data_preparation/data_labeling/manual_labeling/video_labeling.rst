...
#. .. _en-us_topic_0000002571542741__en-us_topic_0000001185265235_li993163014399:
   ...
   The supported labeling boxes are the same as those for object detection. For details, see :ref:`Table 2 <en-us_topic_0000002540902750__en-us_topic_0000001185265231_table194471512463>`.

#. After the previous image is labeled, click the play button on the progress bar to resume the playback. Then, repeat :ref:`3 <en-us_topic_0000002571542741__en-us_topic_0000001185265235_li993163014399>` to complete labeling on the entire video.

   Click **Label List** in the upper right corner of the page. The time points when the video is labeled are displayed.


   .. figure:: /_static/images/en-us_image_0000002571542889.png
