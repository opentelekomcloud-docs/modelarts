...
ModelArts is a one-stop AI development platform that supports AI lifecycle development, including data processing, algorithm development, model training, and model deployment. In addition, ModelArts provides AI Hub that can be used to share data, algorithms, and models. ModelArts Data Preparation provides end-to-end data preparation, processing, and labeling.

ModelArts Data Preparation provides the following functions for you to obtain high-quality AI data:
...
-  More efficient data preparation
   ...
   -  Allows you to manage data by version for more efficient Data Preparation.
