...
#. Log in to the ModelArts management console. In the navigation pane on the left, choose **Datasets**.
...
#. Click **Create**. On the **Create Dataset** page, create a dataset based on the data type and data labeling requirements. Enter the basic information about the dataset.
   ...
   .. figure:: /_static/images/en-us_image_0000002543842322.png
   ...
   -  For more details about parameters, see :ref:`Table 1 <en-us_topic_0000002571422771__en-us_topic_0000001139785210_table18965124216518>`.

      .. _en-us_topic_0000002571422771__en-us_topic_0000001139785210_table18965124216518:
...
#. Click **Create**. On the **Create Dataset** page, create a dataset based on the data type and data labeling requirements. Enter the basic information about the dataset.
   ...
   -  For more details about parameters, see :ref:`Table 2 <en-us_topic_0000002571422771__table78034844518>`.

      .. _en-us_topic_0000002571422771__table78034844518:
      ...
      .. table:: **Table 2** Dataset parameters
         ...
         +-----------------------------------+----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
         | Schema                            | Names and types of table columns, which must be the same as those of the imported data. Set the column name based on the imported data and select the column type. For details about the supported types, see :ref:`Table 3 <en-us_topic_0000002571422771__table5251155510463>`. |
         |                                   |                                                                                                                                                                                                                                                                                  |
      ...
      .. _en-us_topic_0000002571422771__table5251155510463:
