...
#. Open MobaXterm and click **Settings** on the menu bar.
   ...
   .. figure:: /_static/images/en-us_image_0000002268821677.png
...
#. On the MobaXterm configuration page, click the **SSH** tab and select **SSH keepalive**.
   ...
   .. figure:: /_static/images/en-us_image_0000002233902324.png
   ...
   .. note::
      ...
      If MobaXterm Professional is used, go to :ref:`step 3 <en-us_topic_0000002233740680__li20358102665416>`.

#. .. _en-us_topic_0000002233740680__li20358102665416:

   Change the default value **360 seconds** to **3600 seconds** or a larger value for **Stop server after**.


   .. figure:: /_static/images/en-us_image_0000002268741765.png
