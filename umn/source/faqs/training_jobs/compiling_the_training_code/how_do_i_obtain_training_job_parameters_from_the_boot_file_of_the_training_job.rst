...
#. After the training job is executed, you can click the job name in the training job list to view its details. You can obtain the parameter input mode from logs, as shown in :ref:`Figure 1 <en-us_topic_0000002268739961__fig74929528456>`.

   .. _en-us_topic_0000002268739961__fig74929528456:

   .. figure:: /_static/images/en-us_image_0000002268740597.png
