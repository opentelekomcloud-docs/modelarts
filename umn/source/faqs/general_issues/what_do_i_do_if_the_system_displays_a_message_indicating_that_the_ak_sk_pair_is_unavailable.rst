...
#. Use the current account to log in to the OBS console and check whether the current account can access OBS.
   ...
   -  If the account can access OBS, rectify the fault by referring to :ref:`2 <en-us_topic_0000002540902898__li181091239132313>`.

#. .. _en-us_topic_0000002540902898__li181091239132313:
