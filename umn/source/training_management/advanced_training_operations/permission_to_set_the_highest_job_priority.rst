...
#. .. _en-us_topic_0000002541062502__li1793015304613:
...
#. In the navigation pane, choose **User Groups**. Then, click **Authorize** in the **Operation** column of the target user group. On the **Authorize User Group** page, select the custom policies created in :ref:`2 <en-us_topic_0000002541062502__li1793015304613>`, and click **Next**. Then, select the scope and click **OK**.
