...
-  When configuring an agency, you can use an automatically created agency. For details, see `Automatically Creating an IAM Agency <#modelarts080007enustopic0284258827enustopic0256240291section19256347172519>`__. You can also configure an agency. For example, you can configure an IAM user with the agency valid for only one day.
