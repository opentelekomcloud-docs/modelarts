...
.. table:: **Table 4** Response body parameters
   ...
   +--------------+-------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------+
   | events       | Array of :ref:`Events <en-us_topic_0000002341058274__en-us_topic_0000002091282849_response_events>` objects | Event logs of a service                                                          |
   +--------------+-------------------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------+

.. _en-us_topic_0000002341058274__en-us_topic_0000002091282849_response_events:
