...
.. _en-us_topic_0000002268768417__en-us_topic_0170917207_en-us_topic_0168405763_section1849899574:
...
.. table:: **Table 1** Request URI
   ...
   +---------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | Endpoint      | Domain name or IP address of the server for the REST service endpoint. The endpoint varies depending on services in different regions. It can be obtained in :ref:`Endpoint <en-us_topic_0000002268768401__section2081352311426>`.                           |
   +---------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
:ref:`Table 3 <en-us_topic_0000002268768417__table139019272562>` describes common request header fields.

.. _en-us_topic_0000002268768417__table139019272562:
