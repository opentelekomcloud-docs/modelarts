...
#. .. _en-us_topic_0000002233769032__li94791126103617:

   Import the demo project to Eclipse.


   .. figure:: /_static/images/en-us_image_0000002282943685.png
      :alt: **Figure 1** Select an existing project

      **Figure 1** Select an existing project


   .. figure:: /_static/images/en-us_image_0000002282852717.png
      :alt: **Figure 2** Selecting the demo project

      **Figure 2** Selecting the demo project


   .. figure:: /_static/images/en-us_image_0000002247812886.png
...
#. Sign the request.
   ...
   The request signing method is integrated in the JAR files imported in :ref:`3 <en-us_topic_0000002233769032__li94791126103617>`. Before sending the request, sign the requested content. The obtained signature is included in the HTTP header of the request.
...
.. |image1| image:: /_static/images/en-us_image_0000002282853397.png
