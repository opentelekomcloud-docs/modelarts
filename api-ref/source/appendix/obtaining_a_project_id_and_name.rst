...
-  :ref:`Obtaining a Project ID and Name from the Console <en-us_topic_0000002374896705__section1747620762418>`
-  :ref:`Obtaining a Project ID by Calling an API <en-us_topic_0000002374896705__section3926171216207>`

.. _en-us_topic_0000002374896705__section1747620762418:
...
.. _en-us_topic_0000002374896705__section3926171216207:

Obtaining a Project ID by Calling an API
----------------------------------------

The API for obtaining a project ID is **GET https://**\ *{iam-endpoint}*\ **/v3/projects**. To obtain *{iam-endpoint}*, see :ref:`Request URI <en-us_topic_0000002374896665__en-us_topic_0170917207_en-us_topic_0168405763_section1849899574>`\ :ref:`Endpoint <modelarts_03_0141>`.
