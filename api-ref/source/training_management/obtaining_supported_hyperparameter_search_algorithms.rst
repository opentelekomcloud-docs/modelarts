:original_name: ShowSearchAlgorithms.html
...
.. table:: **Table 2** Response body parameters
   ...
   +-------------------+---------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+
   | search_algo_list  | Array of :ref:`search_algo_list <en-us_topic_0000002268726173__en-us_topic_0000002055322430_response_search_algo_list>` objects | List of all hyperparameter search algorithms. |
   +-------------------+---------------------------------------------------------------------------------------------------------------------------------+-----------------------------------------------+

.. _en-us_topic_0000002268726173__en-us_topic_0000002055322430_response_search_algo_list:
...
.. table:: **Table 3** search_algo_list
   ...
   +-------------+-------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
   | params      | Array of :ref:`params <en-us_topic_0000002268726173__en-us_topic_0000002055322430_response_params>` objects | List of hyperparameter search algorithm parameters. |
   +-------------+-------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+
   | description | String                                                                                                      | Description of a hyperparameter search algorithm.   |
   +-------------+-------------------------------------------------------------------------------------------------------------+-----------------------------------------------------+

.. _en-us_topic_0000002268726173__en-us_topic_0000002055322430_response_params:
