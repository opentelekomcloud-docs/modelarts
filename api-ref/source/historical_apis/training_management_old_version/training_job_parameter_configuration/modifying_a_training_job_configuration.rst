...
:ref:`Table 1 <en-us_topic_0000002233928740__table5935107791848>` describes the required parameters.

.. _en-us_topic_0000002233928740__table5935107791848:
...
:ref:`Table 2 <en-us_topic_0000002233928740__table5503766015447>` describes the request parameters.

.. _en-us_topic_0000002233928740__table5503766015447:
...
.. table:: **Table 2** Parameters
   ...
   +--------------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | parameter          | No              | Array<Object>   | Running parameters of a training job. It is a collection of label-value pairs. This parameter is a container environment variable when a training job uses a custom image. For details, see :ref:`Table 4 <en-us_topic_0000002233928740__table1267642234716>`.                 |
   +--------------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   ...
   +--------------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
   | data_source        | No              | JSON Array      | Dataset of a training job. This parameter cannot be used together with **data_url** or **dataset_id** and **dataset_version_id**. For details, see :ref:`Table 3 <en-us_topic_0000002233928740__table250595919011>`.                                                           |
   +--------------------+-----------------+-----------------+--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
...
.. _en-us_topic_0000002233928740__table250595919011:
...
.. _en-us_topic_0000002233928740__table1267642234716:
...
:ref:`Table 5 <en-us_topic_0000002233928740__table5371703815645>` describes the response parameters.

.. _en-us_topic_0000002233928740__table5371703815645:
