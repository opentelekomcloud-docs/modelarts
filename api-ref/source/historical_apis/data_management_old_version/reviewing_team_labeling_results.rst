...
.. table:: **Table 2** Request body parameters
   ...
   | Parameter | Mandatory | Type                                                                                        | Description          |
   +===========+===========+=============================================================================================+======================+
   | comments  | No        | Array of :ref:`SampleComment <en-us_topic_0000002340898798__request_samplecomment>` objects | Review comment list. |
   +-----------+-----------+---------------------------------------------------------------------------------------------+----------------------+

.. _en-us_topic_0000002340898798__request_samplecomment:
...
The following is an example of how to review team labeling results. **accept** has been set to **true** and **score** has been set to **A**.
