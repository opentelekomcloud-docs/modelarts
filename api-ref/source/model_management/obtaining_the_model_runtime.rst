...
.. table:: **Table 4** Response body parameters
   ...
   +-----------------+---------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------+
   | engine_runtimes | Array of :ref:`EngineAndRuntimesResponse <en-us_topic_0000002268806169__en-us_topic_0000002055164110_response_engineandruntimesresponse>` objects | Engine runtime environment                                                                                                                 |
   +-----------------+---------------------------------------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------------+

.. _en-us_topic_0000002268806169__en-us_topic_0000002055164110_response_engineandruntimesresponse:
...
.. table:: **Table 5** EngineAndRuntimesResponse
   ...
   +-----------------------+-----------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------+
   | accelerators          | Array of :ref:`Accelerator <en-us_topic_0000002268806169__en-us_topic_0000002055164110_response_accelerator>` objects | Accelerator cards that can be used by the AI engine.                                 |
   +-----------------------+-----------------------------------------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------+
...
.. _en-us_topic_0000002268806169__en-us_topic_0000002055164110_response_accelerator:
