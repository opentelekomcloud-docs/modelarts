...
A service endpoint consists of the service name, region ID, and external domain name in the format of "{service_name}.{region_id}.{external_domain_name}". :ref:`Table 1 <en-us_topic_0000002374896737__en-us_topic_0000001072357044_table24011519165716>` describes these parameters.

.. _en-us_topic_0000002374896737__en-us_topic_0000001072357044_table24011519165716:
