:original_name: modelarts_04_0186.html
...
-  Method 2: Stop the visualization job created in :ref:`Creating a Visualization Job <modelarts_04_0181>`.

   ::

      status = job_visualization_instance.stop_visualization_job()

-  Method 3: Stop the visualization job object returned in :ref:`Querying the List of Visualization Job Objects <modelarts_04_0182>`.
...
.. table:: **Table 2** **stop_visualization_job** response parameters
