...
otcdocs_doc_link = '/modelarts/sdk-ref/'
otcdocs_doc_title = 'ModelArts Software Development Kit (ModelArts SDK)'
otcdocs_doc_type = 'sdk-ref'
...
html_title = "ModelArts - ModelArts Software Development Kit (ModelArts SDK)"
